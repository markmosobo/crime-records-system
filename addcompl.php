						...
						<div class="form-row">
                        		<div class="col-md-6">
					  				<div class="form-group">
					    				...
					    				<input type="text" name="region" class="form-control" id="country" placeholder="Enter region" >
					  			...
					  			<div class="col-md-6">
					  				<div class="form-group">
					    				...
					    				<input type="text" name="district" class="form-control" id="state" placeholder="Enter district" >
					  				</div>
					  			</div>
					  		</div>
					<div class="form-row">
